...
export class AutocompleteService {
  private readonly baseUrl = 'https://aminuus-backend.onrender.com/api/policies/autocomplete';
  
  private readonly ApiUrl = 'https://aminuus-backend.onrender.com/api/appointments';
