...
RETURNS TABLE(company_id INTEGER, company_name VARCHAR)
LANGUAGE plpgsql
AS $$
BEGIN
    RETURN QUERY
...
RETURNS TABLE(type_id INTEGER, type_name VARCHAR)
LANGUAGE plpgsql
AS $$
BEGIN
    RETURN QUERY
...
CREATE OR REPLACE FUNCTION sp_get_performance_metrics(
    ...
    p_period VARCHAR(20) DEFAULT 'month' -- 'week', 'month', 'quarter', 'year'
)
RETURNS TABLE(
    period_start DATE,
    period_end DATE,
...
CREATE OR REPLACE FUNCTION sp_upsert_appointment(
...
CREATE OR REPLACE FUNCTION sp_get_appointments(
    p_agent_id UUID,
    p_date_range_filter VARCHAR(20) DEFAULT 'all', -- 'all', 'today', 'week', 'month'
...
CREATE OR REPLACE FUNCTION sp_get_today_appointments(
    p_agent_id UUID
) RETURNS TABLE (
    appointment_id UUID,
    client_id UUID,
...
CREATE OR REPLACE FUNCTION sp_get_appointment_statistics(
    p_agent_id UUID
) RETURNS TABLE (
    today_appointments BIGINT,
    week_appointments BIGINT,
...
CREATE OR REPLACE FUNCTION sp_update_reminder_setting(
    p_agent_id UUID,
    p_reminder_type VARCHAR(50),
...
CREATE OR REPLACE FUNCTION sp_get_client_with_policies(
    p_client_id UUID,
    p_agent_id UUID
)
RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION sp_get_client_policies_details(
    p_client_id UUID
)
RETURNS TABLE (
    policy_id UUID,
...
BEGIN
    ...
    SELECT 
        ...
        cp.start_date,
        cp.end_date,
        (cp.end_date - CURRENT_DATE)::INTEGER as days_to_expiry,
        cp.notes,
        cp.created_date
    FROM client_policies cp
...
CREATE OR REPLACE FUNCTION sp_get_client_recent_appointments(
    p_client_id UUID
)
RETURNS TABLE (
    appointment_id UUID,
...
CREATE OR REPLACE FUNCTION sp_get_client_active_reminders(
    p_client_id UUID
)
RETURNS TABLE (
    reminder_id UUID,
...
BEGIN
    ...
    IF NOT EXISTS(SELECT 1 FROM clients WHERE client_id = p_client_id AND agent_id = p_agent_id AND is_active = true) THEN
        RETURN QUERY SELECT 
            0 as success,
            'Client not found'::TEXT as message;
        RETURN;
    END IF;
...
CREATE OR REPLACE FUNCTION sp_get_enhanced_client_statistics(
    p_agent_id UUID
)
RETURNS TABLE (
    total_clients BIGINT,
...
CREATE OR REPLACE FUNCTION sp_delete_policy_catalog(
    p_policy_catalog_id UUID,
    p_agent_id UUID
)
RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION sp_CreateClientPolicy(
    p_client_id UUID,
    p_policy_catalog_id UUID,
    p_status VARCHAR(20) DEFAULT 'Active',
    p_start_date DATE,
...
-- Get Expiring Policies
CREATE OR REPLACE FUNCTION sp_GetExpiringPolicies(
    p_agent_id UUID,
    p_days_ahead INTEGER DEFAULT 30
)
RETURNS TABLE(
...
-- Get Insurance Companies
CREATE OR REPLACE FUNCTION sp_GetInsuranceCompanies(
    p_is_active BOOLEAN DEFAULT true
)
RETURNS TABLE(
    company_id UUID,
...
-- Get Policy Types
CREATE OR REPLACE FUNCTION sp_GetPolicyTypes(
    p_is_active BOOLEAN DEFAULT true
)
RETURNS TABLE(
    type_id UUID,
...
CREATE OR REPLACE FUNCTION sp_GetPolicyCategories(
    p_is_active BOOLEAN DEFAULT true
)
RETURNS TABLE(
    category_id UUID,
...
-- Validate Policy Data
CREATE OR REPLACE FUNCTION sp_ValidatePolicyData(
    p_policy_name VARCHAR(100),
    p_type_id UUID,
    p_company_id UUID DEFAULT NULL,
    p_start_date DATE DEFAULT NULL,
...
-- Get Policy Statistics
CREATE OR REPLACE FUNCTION sp_GetPolicyStatistics(
    p_agent_id UUID
)
RETURNS TABLE(
    active_policies BIGINT,
...
-- Create Policy Template
CREATE OR REPLACE FUNCTION sp_CreatePolicyTemplate(
    p_agent_id UUID,
    p_template_name VARCHAR(100),
    p_type_id UUID,
    p_default_term_months INTEGER DEFAULT NULL,
...
-- Get Policy Templates
CREATE OR REPLACE FUNCTION sp_GetPolicyTemplates(
    p_agent_id UUID,
    p_type_id UUID DEFAULT NULL
)
RETURNS TABLE(
...
-- Delete Policy Template
CREATE OR REPLACE FUNCTION sp_DeletePolicyTemplate(
    p_template_id UUID,
    p_agent_id UUID
)
...
-- Get Policy Catalog for Agent
CREATE OR REPLACE FUNCTION sp_GetPolicyCatalog(
    p_agent_id UUID,
    p_type_id UUID DEFAULT NULL,
    p_company_id UUID DEFAULT NULL
)
...
-- Create Policy Catalog Item
CREATE OR REPLACE FUNCTION sp_CreatePolicyCatalogItem(
    p_agent_id UUID,
    p_policy_name VARCHAR(100),
    p_type_id UUID,
    p_company_id UUID DEFAULT NULL,
...
-- Update Policy Catalog Item
CREATE OR REPLACE FUNCTION sp_UpdatePolicyCatalogItem(
    p_policy_catalog_id UUID,
    p_agent_id UUID,
    p_policy_name VARCHAR(100) DEFAULT NULL,
    p_type_id UUID DEFAULT NULL,
...
-- Delete Policy from Catalog
CREATE OR REPLACE FUNCTION sp_DeletePolicyCatalog(
    p_policy_catalog_id UUID,
    p_agent_id UUID
)
RETURNS TABLE(rows_affected INTEGER)
...
-- Create or Update Client Policy
CREATE OR REPLACE FUNCTION sp_UpsertClientPolicy(
    p_policy_id UUID DEFAULT NULL,
    p_client_id UUID,
    p_policy_name VARCHAR(100),
    p_type_id UUID,
...
-- Get Client Policies
CREATE OR REPLACE FUNCTION sp_GetClientPolicies(
    p_client_id UUID,
    p_status VARCHAR(20) DEFAULT NULL,
    p_type_id UUID DEFAULT NULL
)
...
-- Update Client Policy
CREATE OR REPLACE FUNCTION sp_UpdateClientPolicy(
    p_policy_id UUID,
    p_policy_catalog_id UUID DEFAULT NULL,
    p_policy_name VARCHAR(100) DEFAULT NULL,
    p_type_id UUID DEFAULT NULL,
...
CREATE OR REPLACE FUNCTION sp_GetPolicyStatisticsDetailed(
    p_agent_id UUID
)
RETURNS TABLE(
    total_policies BIGINT,
...
CREATE OR REPLACE FUNCTION sp_GetExpiringPoliciesByPeriod(
    p_agent_id UUID DEFAULT NULL,
    p_period VARCHAR(20)
)
RETURNS TABLE(
...
CREATE OR REPLACE FUNCTION sp_CreatePolicyCategory(
...
CREATE OR REPLACE FUNCTION sp_UpdatePolicyTemplate(
    p_template_id UUID,
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_DeleteClientPolicy(
    p_policy_id UUID,
    p_agent_id UUID
)
RETURNS TABLE(rows_affected INTEGER)
...
CREATE OR REPLACE FUNCTION fn_format_client_name(first_name VARCHAR(50), surname VARCHAR(50), last_name VARCHAR(50) DEFAULT NULL)
...
CREATE OR REPLACE FUNCTION get_policies_by_status(
    p_status VARCHAR(20),
    p_agent_id UUID DEFAULT NULL
)
RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION bulk_update_policy_status(
...
CREATE OR REPLACE FUNCTION get_policy_templates(
    p_agent_id UUID DEFAULT NULL,
    p_category_id UUID DEFAULT NULL,
    p_type_id UUID DEFAULT NULL,
    p_is_active BOOLEAN DEFAULT true
...
CREATE OR REPLACE FUNCTION create_policy_template(
    p_agent_id UUID,
    p_template_name VARCHAR(100),
    p_default_term_months INTEGER DEFAULT NULL,
    p_default_premium DECIMAL(18, 2) DEFAULT NULL,
...
CREATE OR REPLACE FUNCTION update_policy_template(
    p_template_id UUID,
    p_template_name VARCHAR(100) DEFAULT NULL,
    p_default_term_months INTEGER DEFAULT NULL,
    p_default_premium DECIMAL(18, 2) DEFAULT NULL,
...
CREATE OR REPLACE FUNCTION delete_policy_template(
    p_template_id UUID,
    p_hard_delete BOOLEAN DEFAULT false
)
RETURNS TABLE (
...
CREATE OR REPLACE FUNCTION get_insurance_companies(
...
CREATE OR REPLACE FUNCTION get_policy_types(
    is_active_param BOOLEAN DEFAULT TRUE
)
RETURNS TABLE(
    type_id UUID,
...
CREATE OR REPLACE FUNCTION get_policy_categories(
    is_active_param BOOLEAN DEFAULT TRUE
)
RETURNS TABLE(
    category_id UUID,
...
CREATE OR REPLACE FUNCTION create_policy_category(
...
CREATE OR REPLACE FUNCTION create_insurance_company(
...
CREATE OR REPLACE FUNCTION create_policy_type(
...
CREATE OR REPLACE FUNCTION get_policy_renewal_candidates(
...
CREATE OR REPLACE FUNCTION get_agent_dashboard_summary(
    agent_id_param UUID
)
RETURNS TABLE(
...
CREATE OR REPLACE FUNCTION update_insurance_company(
...
CREATE OR REPLACE FUNCTION update_policy_type(
    type_id_param UUID,
...
CREATE OR REPLACE FUNCTION get_policy_history_for_client(
...
CREATE OR REPLACE FUNCTION batch_expire_policies(
...
CREATE OR REPLACE FUNCTION cleanup_soft_deleted_records(
    days_old_param INTEGER DEFAULT 365,
...
CREATE OR REPLACE FUNCTION sp_get_insurance_company_by_id(
    company_id_param UUID
)
RETURNS TABLE(
    company_id UUID,
...
CREATE OR REPLACE FUNCTION sp_delete_insurance_company(
    company_id_param UUID,
...
CREATE OR REPLACE FUNCTION sp_get_policy_category_by_id(
    category_id_param UUID
)
RETURNS TABLE(
    category_id UUID,
...
CREATE OR REPLACE FUNCTION sp_update_policy_category(
    category_id_param UUID,
    category_name_param VARCHAR(100),
    company_id_param UUID,
    is_active_param BOOLEAN
...
CREATE OR REPLACE FUNCTION sp_delete_policy_category(
    category_id_param UUID,
    hard_delete_param BOOLEAN DEFAULT FALSE
)
RETURNS INTEGER AS $
...
CREATE OR REPLACE FUNCTION sp_create_policy_type(
    type_name_param VARCHAR(50),
    is_active_param BOOLEAN DEFAULT TRUE
)
RETURNS TABLE(
...
CREATE OR REPLACE FUNCTION sp_get_policy_type_by_id(
    type_id_param UUID
)
RETURNS TABLE(
    type_id UUID,
...
CREATE OR REPLACE FUNCTION sp_update_policy_type(
    type_id_param UUID,
    type_name_param VARCHAR(50),
    is_active_param BOOLEAN
)
...
CREATE OR REPLACE FUNCTION sp_delete_policy_type(
    type_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION sp_soft_delete_policy_template(
...
CREATE OR REPLACE FUNCTION sp_soft_delete_policy_catalog(
    policy_catalog_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
    rows_affected INTEGER;
...
CREATE OR REPLACE FUNCTION sp_soft_delete_policy_category(
    category_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION sp_soft_delete_insurance_company(
    company_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION sp_soft_delete_client_policy(
...
CREATE OR REPLACE FUNCTION client_policies_soft_delete(
    policy_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION insurance_companies_soft_delete(
    company_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION policy_catalog_soft_delete(
    policy_catalog_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION policy_categories_soft_delete(
    category_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION policy_templates_soft_delete(
    template_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION policy_types_soft_delete(
    type_id_param UUID
)
RETURNS INTEGER AS $
DECLARE
...
CREATE OR REPLACE FUNCTION get_clients_with_policies(
    agent_id_param UUID DEFAULT NULL,
...
BEGIN
    ...
    SELECT 
        ...
        c.phone_number AS client_phone,
        c.email AS client_email,
        (c.first_name || ' ' || c.surname)::VARCHAR(152) AS full_client_name
    FROM reminders r
    LEFT JOIN clients c ON r.client_id = c.client_id
...
BEGIN
    ...
    SELECT 
        ...
        r.reminder_type::VARCHAR(200) AS detail2,
        r.status::VARCHAR(50)
    FROM reminders r
    WHERE r.agent_id = p_agent_id
        AND (
...
CREATE OR REPLACE FUNCTION sp_update_application_setting(
...
CREATE OR REPLACE FUNCTION sp_get_notification_preferences(
    p_agent_id UUID
)
RETURNS TABLE(
    preference_id UUID,
...
CREATE OR REPLACE FUNCTION sp_update_notification_preferences(
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_get_system_preferences(
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_update_system_preference(
    p_agent_id UUID,
...
-- Get Backup Settings
CREATE OR REPLACE FUNCTION sp_get_backup_settings(
    p_agent_id UUID
)
RETURNS TABLE(
...
CREATE OR REPLACE FUNCTION sp_update_backup_settings(
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_create_message_template(
    p_agent_id UUID,
    p_template_name VARCHAR(100),
    p_message_type VARCHAR(50),
    p_template TEXT,
...
CREATE OR REPLACE FUNCTION sp_get_message_templates(
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_update_message_template(
    p_template_id UUID,
    p_agent_id UUID,
    p_template_name VARCHAR(100),
    p_template TEXT,
...
CREATE OR REPLACE FUNCTION sp_delete_message_template(
    p_template_id UUID,
    p_agent_id UUID
)
RETURNS INTEGER AS $$
...
CREATE OR REPLACE FUNCTION sp_increment_template_usage(
    p_template_id UUID
)
RETURNS VOID AS $$
BEGIN
...
-- Export Agent Data
CREATE OR REPLACE FUNCTION sp_export_agent_data(
    p_agent_id UUID,
...
CREATE OR REPLACE FUNCTION sp_validate_import_data(
    p_agent_id UUID,
...
-- Get Agent Settings
CREATE OR REPLACE FUNCTION sp_get_agent_settings(
    p_agent_id UUID
)
RETURNS TABLE(
    agent_id UUID,
...
-- Toggle Dark Mode
CREATE OR REPLACE FUNCTION sp_toggle_dark_mode(
    p_agent_id UUID
)
RETURNS BOOLEAN AS $$
DECLARE
...
-- Validate Email
CREATE OR REPLACE FUNCTION sp_validate_email(
    p_email VARCHAR(100)
)
RETURNS TABLE(
    is_valid BOOLEAN,
...
CREATE OR REPLACE FUNCTION sp_validate_national_id(
    p_national_id VARCHAR(20)
)
RETURNS TABLE(
    is_valid BOOLEAN,
...
CREATE OR REPLACE FUNCTION sp_check_data_integrity(
    p_agent_id UUID
)
RETURNS TABLE(
    issue_type TEXT,
